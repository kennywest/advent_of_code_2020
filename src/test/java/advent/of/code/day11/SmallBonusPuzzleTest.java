...
public class SmallBonusPuzzleTest {

    @Before
    public void setUp() throws Exception {
        var seatRepository = SeatRepository.INSTANCE;
        new Grid("input_11_1.txt", new SurroundingSeatsSpotter.Difficult()
    ...
    public void shouldSettle() {
        ...
        assertThat(seatRepository.getNumberOfOccupiedSeats()).isEqualTo(26);
    }
}
